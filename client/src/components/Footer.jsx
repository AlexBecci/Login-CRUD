...
function Footer() {
  return (
    <footer className="text-zinc-100 body-font">
      <div className="container px-5 py-8 sm:py-2 mx-auto flex items-center sm:flex-row flex-row justify-between">
        
        <p className="text-sm text-gray-300  sm:mx-4 sm:px-4 sm:border-l-2 sm:border-r-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © 2023 —
          <a
        ...
        <span className="inline-flex mx-4  sm:mt-0 mt-4 justify-center sm:justify-start">
          <a
            target="_blank"
            href="hhttps://github.com/AlexBecci"
